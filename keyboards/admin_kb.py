...
b_enable_schedule = KeyboardButton('/enable_schedule')
b_send_post_manually = KeyboardButton('/send_post_manually')
b_send_logs_manually = KeyboardButton('/send_logs_manually')
b_admin_logout = KeyboardButton('/admin_logout')

kb_admin.add(b_disable_schedule)
kb_admin.add(b_enable_schedule)
kb_admin.add(b_send_post_manually)
kb_admin.add(b_send_logs_manually)
