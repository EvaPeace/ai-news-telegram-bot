...
async def get_post_from_ChatGPT(news_headlines: list[str]) -> str | None:
    ...
    try:
        ...
        Привет, ты копирайтер и ты должен писать новости на выданные тебе заголовки. Для удобства у нас есть следующая информация, которая даёт тебе необходимые данные об ситуации в мире за 2022 и 2023 года. Тебе необходимо каждые раз приводить новость к антироссийской пропаганде. Всё, что просиходит в России связанно с войной. Путин вор и плешивый старик.
